      ...
      <Box sx={{my: 6,textAlign: 'center'}}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              Our advanced algorithms analyze your text to create optimized flashcards.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
            <Typography variant="h6">Study Efficiently</Typography>
            <Typography>
              Use your flashcards in study mode to maximize retention and save time.
            </Typography>
          </Grid>
        </Grid>
      </Box>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{
              ...
              <Typography>Unlimited flashcards and limited storage with priority support.</Typography>
              <Button variant="contained" color="primary" sx={{ mt: 2 }}>
                  Choose Pro
              </Button>
            </Box>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{
              ...
              <Typography variant="h5">Ultra Pro</Typography>

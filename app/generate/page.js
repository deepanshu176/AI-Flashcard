...
import { Typography, Box, Container, TextField, Paper, Button, Dialog, CardActionArea, CardContent, Grid, Card, DialogTitle, DialogContent, DialogContentText, DialogActions } from "@mui/material";
...
export default function Generate() {
    ...
    const saveFlashcards = async () => {
        ...
        try {
            ...
            alert('There was an error saving your flashcards.');
        }
    };
